...
public class WeixinUtil {
	...
	public static Document verifyCertPost(String wsPart, String doc_str,String mchid, String p12_path){
		try {
			
		    KeyStore keyStore  = KeyStore.getInstance("PKCS12");
	        FileInputStream instream = new FileInputStream(new File(p12_path));
...
//		System.out.println(agent);
	...
	public static String getUnionId() throws IOException{
		String unionId = (String)ThreadContextHolder.getSession().getAttribute(WeixinPuginConfig.UNIONID_SESSION_KEY);
	...
	public static String getOpenId() throws IOException{
		String openid = (String)ThreadContextHolder.getSession().getAttribute(WeixinPuginConfig.OPENID_SESSION_KEY);
